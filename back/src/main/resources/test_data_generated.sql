...
VALUES
    ...
    (1, 3, 0, 0, NULL, '请问樱花的最佳观赏时间具体是什么时候？', 0, NOW()),
    ...
    (2, 7, 2, 2, 1, '青岛确实不错，我去年去过，推荐海边的几个景点。', 0, NOW()),
    
    -- 帖子3的评论
    (3, 4, 0, 0, NULL, '秋天去香山怎么样？听说红叶很美。', 0, NOW()),
    (3, 5, 0, 0, NULL, '推荐去婺源，秋天的景色也很不错。', 0, NOW()),
    (3, 8, 2, 2, 4, '香山的红叶确实不错，但人会比较多，建议早上去。', 0, NOW()),
    ...
    -- 帖子6的评论
    (6, 3, 0, 0, NULL, '川藏线风景确实美，但对驾驶技术要求高。', 0, NOW()),
